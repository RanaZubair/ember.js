...
moduleFor('Ember.Engine initializers', class extends TestCase {
  ...
  ['@test initializers require proper \'name\' and \'initialize\' properties'](assert) {
  ...
  ['@test initializers can be registered in a specified order'](assert) {
    ...
    assert.deepEqual(order, ['@test first', 'second', 'third', 'fourth', 'fifth', 'sixth']);
  }
